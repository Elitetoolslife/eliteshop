...
<div class="row g-3 mb-4 mt-3">
  ...
  <div class="col-6 col-lg-3">
    ...
    <script type="module">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["userorders-table"]=$("#userorders-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/waxa.pw\/orders","type":"GET","data":function(data) {
            ...
            delete data.search.regex;}},"columns":[{"data":"id","name":"id","title":"Id","orderable":true,"searchable":true},{"data":"type","name":"type","title":"Type","orderable":true,"searchable":true},{"data":"price","name":"price","title":"Price","orderable":true,"searchable":true,"className":"text-center"},{"data":"seller_id","name":"seller_id","title":"Seller","orderable":true,"searchable":true,"className":"text-center"},{"data":"url","name":"url","title":"Website","orderable":true,"searchable":true,"className":"text-center"},{"data":"login","name":"login","title":"Login","orderable":true,"searchable":true,"visible":false},{"data":"pass","name":"pass","title":"Pass","orderable":true,"searchable":true,"visible":false},{"data":"country","name":"country","title":"Country","orderable":true,"searchable":true,"visible":false},{"data":"report_status","name":"report_status","title":"Status","orderable":true,"searchable":true,"width":10},{"data":"created_at","name":"created_at","title":"Purshased","orderable":true,"searchable":true},{"data":"creation_date","name":"creation_date","title":"Creation Date","orderable":true,"searchable":true,"visible":false},{"data":"updated_at","name":"updated_at","title":"Updated At","orderable":true,"searchable":true,"visible":false},{"data":"view","name":"view","title":"View","orderable":false,"searchable":false,"width":"10%","className":"text-center"},{"data":"report","name":"report","title":"Report","orderable":false,"searchable":false,"width":"15%","className":"text-center"}],"dom":"Bfrtip","order":[0,"desc"],"select":{"style":"single"},"responsive":true,"autoWidth":false,"autoHeight":false,"buttons":[{"extend":"excel"},{"extend":"csv"},{"text":"Text","action":function ( e, dt, button, config ) {
...
<script>
    function viewOrder(element, event) {
        ...
        const rows = fields.map(({ condition, label, value, copyable }) => 
            condition ? `
            <tr>
